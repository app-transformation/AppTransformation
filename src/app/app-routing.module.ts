...
import { TransformationInitiativePageComponent } from './modules/transformation/containers/transformation-initiative-page/transformation-initiative-page.component';
import { TransformationPageComponent } from './modules/transformation/search/containers';
import { ActivityHistoryComponent } from './modules/transformation/activity-history/components';
...
const route: Routes = [
  {
    path: '',
    redirectTo: ROUTES.TRANSFORMATION,
    pathMatch: 'full',
  },
  {
    path: 'login',
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            path: '',
              component: TransformationPageComponent
          },
          {
            path: 'history',
      ...
      {
        path: 'transformation-initiative',
        pathMatch: 'full',
        // canActivate: [AuthGuard],
        children: [
          {
            path: '',
            component: TransformationInitiativePageComponent
          }
        ]
      },
      {
        path: 'transformation-initiative/:id',
        component: TransformationInitiativePageComponent,
        // canActivate: [AuthGuard]
      },
      {
